...
def serializedATN():
    return [
        4,1,46,397,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,
        ...
        115,116,3,12,6,0,116,117,5,43,0,0,117,119,5,20,0,0,118,120,3,16,
        ...
        0,0,140,147,5,43,0,0,141,142,5,43,0,0,142,143,5,24,0,0,143,147,5,
        ...
        1,0,0,0,190,31,1,0,0,0,191,199,5,43,0,0,192,193,5,43,0,0,193,195,
        ...
        35,1,0,0,0,204,211,5,43,0,0,205,206,5,43,0,0,206,207,5,24,0,0,207,
        ...
        0,263,271,3,54,27,0,264,265,5,43,0,0,265,267,5,20,0,0,266,268,3,
...
class MOCPParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "INTEIRO", "REAL", "VAZIO", "PRINCIPAL", 
                      ...
                      "C_KEYWORD", "ID", "BLOCK_COMMENT", "LINE_COMMENT", 
                      "WS" ]
    ...
    def block(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 8796097609574) != 0):
                self.state = 149
                self.statement()
                self.state = 154
                self._errHandler.sync(self)
    ...
    def declarator(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if (((_la) & ~0x3f) == 0 and ((1 << _la) & 12163621190656) != 0):
                    self.state = 194
                    self.expr()
    ...
    def forStmt(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & 8796093022214) != 0):
                self.state = 233
                self.forInit()
